from backend.app.automation import map_memory_answers, select_form_adapter
...
def test_map_memory_answers_pauses_for_unknown_and_sensitive_fields() -> None:
    fields = [
    ...
    mapped = map_memory_answers(fields, lambda safe_fields: {
        0: type("Answer", (), {
            "value": "sameer@example.com", "confidence": 0.95,
            "source_reference": "cv.txt", "evidence": "Email in CV.",
        })(),
    })
