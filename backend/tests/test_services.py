from backend.app.automation import map_vault_answers, select_form_adapter
...
def test_map_vault_answers_pauses_for_unknown_and_sensitive_fields() -> None:
    fields = [
    ...
    mapped = map_vault_answers(fields, lambda question, _: type("Answer", (), {
        "value": "sameer@example.com", "confidence": 0.95, "source_kind": "source_document",
        "source_reference": "cv.txt", "reason": "Found in source data.",
    })() if "Email" in question else None)
